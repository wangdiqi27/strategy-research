...
class TrixVptResearch(PandasBacktestingBase):
    ...
    def hybrid_backtest(self,
        ...
        ## ema
        daily_ema_5_arr = bar_1m_exec_df["daily_ema_5"].to_numpy()
        daily_ema_10_arr = bar_1m_exec_df["daily_ema_10"].to_numpy()
        daily_ema_20_arr = bar_1m_exec_df["daily_ema_20"].to_numpy()
        ...
        for i in range(bar_exec_df_copy_length):
            ...
            if cur_position is None or cur_position.volume == 0:
                ...
                if (
                        ...
                        and not (daily_ema_5_arr[i] <= daily_ema_10_arr[i] < daily_ema_20_arr[i])
                ):
                    """多头开仓"""
                ...
                if cur_position.direction == BacktestingDirection.LONG:
                    ...
                    elif daily_ema_5_arr[i] <= daily_ema_10_arr[i] < daily_ema_20_arr[i]:
                        close_reason = 'EMA 空头排列'
